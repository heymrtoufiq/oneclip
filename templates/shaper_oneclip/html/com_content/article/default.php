...
if (!empty($this->item->pagination) && $this->item->pagination && $this->item->paginationposition && !$this->item->paginationrelative):
	...
	if (strpos($this->item->pagination, 'class="icon-chevron-right"') || strpos($this->item->pagination, 'class="icon-chevron-left"')) {
		echo str_replace( array('class="icon-chevron-right"', 'class="icon-chevron-left"'), array('class="fa fa-caret-right"', 'class="fa fa-caret-left"'), $this->item->pagination );
