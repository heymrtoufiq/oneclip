...
if ($tm_variation = $this->helix3->getParam('tm_variation')) {
	$body_classes .= ' variation-' . $tm_variation;
}
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php echo $this->language; ?>" lang="<?php echo $this->language; ?>" dir="<?php echo $this->direction; ?>">
	<head>
		...
		<?php
			...
			->addJS('bootstrap.min.js, jquery.sticky.js, jquery.nav.js, main.js') // JS Files
