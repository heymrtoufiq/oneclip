...
class SppagebuilderAddonPricing extends SppagebuilderAddons {
	...
	public function render() {
		...
		//Options
		$price_position = (isset($this->addon->settings->price_position) && $this->addon->settings->price_position) ? $this->addon->settings->price_position : 'after';
		...
		//Output
		$output  = '<div class="sppb-addon sppb-addon-pricing-table ' . $alignment . ' ' . $class . ' ' . $variation . '">';
		...
		$output .= '</div>';
		if ($pricing_details) {
            $output .= '<p class="sppb-pricing-details">' . $pricing_details . '</p>';
        }
	...
	public static function getTemplate(){
		...
		<#
			...
			let price_position = data.price_position || "after";
		...
		<div class="sppb-addon sppb-addon-pricing-table {{ data.alignment }} {{ data.class }} {{variation}}">
			<div class="sppb-pricing-box {{ data.featured }}">
				...
				<# if (!_.isEmpty(pricing_details)) { #>
					<p class="sppb-pricing-details">{{pricing_details}}</p>
				<# } #>
