...
class SppagebuilderAddonAjax_contact extends SppagebuilderAddons{
	...
	public function render() {
		...
		$output  = '<div class="sppb-addon sppb-addon-ajax-contact ' . $class . ' ' . $variation . '">';
		...
		$output .= '<div class="input-fields pull-left">';
		...
		$output .= '</div>';
		$output .= '</div>'; //.input-fields

		$output .= '<div class="message-submit pull-left text-right">';
		$output .= '<div class="sppb-row">';
		...
		$output .= '<div class="sppb-form-group sppb-col-sm-12">';
	...
	public static function getTemplate(){
		...
		<div class="sppb-addon sppb-addon-ajax-contact {{ data.class }} {{variation}}">
			...
			<div class="sppb-ajax-contact-content">
				<form class="sppb-ajaxt-contact-form">
					<div class="input-fields pull-left">
					<div class="row">
						...
						<div class="message-submit pull-left text-right">
						<div class="sppb-row">
					...
					<# }
					var button_text = (!_.isEmpty(data.button_text)) ? data.button_text : "Send Message";
					#>
					...
					<# } #>
					<button type="submit" id="btn-{{ data.id }}" class="sppb-btn sppb-btn-default {{ classList }}"><i class="fa"></i>  {{ button_text }}</button>
					</div>
					</div>
					</div>
				</form>
